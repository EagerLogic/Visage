        ...
        div {
            ...
            div {
                ...
                Icon(
                    ...
                    if (this@CCheckBox.disabled) {
                        Skin.palette.textWeak
                    } else if (this@CCheckBox.model.error != null) {
                        Skin.palette.errorColor
                    } else if (this@CCheckBox.model.value) {
                        Skin.palette.primaryColor
                    } else {
                        Skin.palette.textStrong
                    },
                    18
                )
            }
            ...
            div {
                ...
                if (this@CCheckBox.disabled) {
                    style.color = Skin.palette.textWeak
                } else if (this@CCheckBox.model.error != null) {
...
private val checkboxContainerStyle = Css.createClass {
    height = "18px"
    fontSize = "16px"
    display = "inline-flex"
    alignItems = "center"
...
private val textContainerStyle = Css.createClass {
    flex = "1"
    fontSize = "14px"
